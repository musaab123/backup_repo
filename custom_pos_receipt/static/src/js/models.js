...
odoo.define('point_of_sale.models', function (require) {
    ...
    exports.PosModel = Backbone.Model.extend({
        ...
        models: [
        {
            ...
            model:  'res.company',
            fields: [ 'currency_id', 'email', 'website','street', 'company_registry', 'vat', 'name', 'phone', 'partner_id' , 'country_id', 'state_id', 'tax_calculation_rounding_method'],
    ...
    exports.Order = Backbone.Model.extend({
        ...
        // console.log($.spellingNumber(12300.23, {lang: "ar"}));
        export_for_printing: function(){
            var orderlines = [];
            var self = this;
            ...
            var receipt = {
                ...
                subtotal_without_discount: this.get_subtotal() - this.get_total_discount(),
