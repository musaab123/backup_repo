...
class AccountMoveLineInherit(models.Model):
    ...
    def reconcile_(self):
            ...
            # ==== Create partials ====
            # partials = self.env['account.partial.reconcile'].create(sorted_lines._prepare_reconciliation_partials(partials_vals))
            # partials = self.env['account.partial.reconcile'].create(sorted_lines._create_reconciliation_partials())
